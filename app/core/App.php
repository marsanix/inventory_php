...
class App
{
    ...
    protected $controller = 'InventoryController';
    ...
    public function __construct()
    {
        ...
        // Ex: call_user_func_array([InventoryController, updateInventory], [$id])
        // In the above example this function will call updateInventory($id) method in InventoryController class
        // --------------------------------------------------------------------------------------------------------------------
